...
public class ExcelStepDefinitions {
    ...
    public void fiziki_olarak_kullanilan_satir_sayisinin_oldugunu_test_eder(Integer fizikiKullanilanSatir) {
        Integer actualFizikiKullanilanSatir = workbook.getSheet("Sayfa1").getPhysicalNumberOfRows();
        Assert.assertEquals(fizikiKullanilanSatir, actualFizikiKullanilanSatir);
    }
}
